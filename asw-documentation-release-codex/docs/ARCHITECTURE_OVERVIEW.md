...
[runtime qualification record](../../asw-spec-codex/docs/RUNTIME_QUALIFICATION_2026-08-02.md).

## Normative and implementation references

- [RFC 0001](../../asw-spec-codex/RFC-0001.md) — normative semantics.
- [Schemas](../../asw-spec-codex/schemas/index.json) — machine-readable
  contracts.
- [Architecture source note](../../asw-spec-codex/docs/ARCHITECTURE.md) —
