...
For normative contracts and operation names, see [RFC 0001 section 18](../../asw-spec-codex/RFC-0001.md#18-agent-interface)
and the [agent schemas](../../asw-spec-codex/schemas/agent-stream-request.schema.json).
