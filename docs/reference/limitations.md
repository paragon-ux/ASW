...
See [Claims and evidence](../research/claims-and-evidence.md) for the claim
classes and [Evaluation reproducibility](../research/reproducibility.md) for
the frozen run boundary.
