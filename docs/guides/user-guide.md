...
contract supports optional event-type filters; see [Agent integration](agent-integration.md)
for an example.
...
For normative semantics, use [RFC 0001](../rfc/RFC-0001.md). For privacy and
authority boundaries, see [Security and privacy](../reference/security-and-privacy.md).
